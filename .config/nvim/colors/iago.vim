...
hi Title	cterm=bold	ctermfg=45	gui=bold	guifg=#5fd75f
hi Title2	cterm=bold	ctermfg=45	gui=bold	guifg=#00d7aa
hi Title3	cterm=bold	ctermfg=45	gui=bold	guifg=#00d7dd
...
hi link TSTitlem2 Title2
hi link TSTitlem3 Title3
hi link TSTodo Todo
hi link TSType Type
...
hi link @markup.heading.2.markdown TSTitlem2
hi link @markup.heading.3.markdown TSTitlem3
